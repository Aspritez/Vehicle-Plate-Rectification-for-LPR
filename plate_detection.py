...
# The physical aspect ratio of a standard Thai license plate is 340mm x 150mm (approx 2.26).
# We narrow the ideal aspect ratio band to strongly favor this shape and avoid background artifacts.
DEFAULT_CONFIG = DetectorConfig(
    aspect_band=(1.2, 1.8, 2.8, 4.0),
    min_aspect=1.0,
    max_aspect=4.5,
)
