"""Thai province names as printed on license plates (77 provinces)."""
...
# Consonants that appear in the registration-letter part of a plate. The obsolete letters
# ฃ and ฅ are never issued, so leaving them out removes common look-alike mistakes (ข/ฃ, ค/ฅ).
